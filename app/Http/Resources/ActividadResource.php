...
class ActividadResource extends Resource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'voucher_rechazo_motivo' => ($estadoInscripcion) ? $inscripcion->voucher_rechazo_motivo : null,
            'scholarship_requested'  => ($estadoInscripcion) ? (bool) $inscripcion->scholarship_requested : false,
