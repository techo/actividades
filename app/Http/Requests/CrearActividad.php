...
class CrearActividad extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'permite_exencion' => 'sometimes|boolean',
            'metodos_pago' => 'sometimes|nullable|array',
            'metodos_pago.transferencia' => 'sometimes|boolean',
            'metodos_pago.link_pix' => 'sometimes|boolean',
            'metodos_pago.tarjeta' => 'sometimes|boolean',
