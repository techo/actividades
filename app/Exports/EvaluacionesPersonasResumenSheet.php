...
class EvaluacionesPersonasResumenSheet implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles, WithTitle
{
    protected $actividad;
    ...
    {
        $actividadId = $this->actividad->idActividad;

        $evaluaciones = EvaluacionPersona::where('idActividad', $actividadId)
            ->with('respuestas')
            ->get();
