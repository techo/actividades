...
return [
	...
	*/
    ...
    // Rediseño "Confirmación y Pago"
    'confirmation_intro' => 'Define cómo los participantes deben confirmar su asistencia o reportar pagos.',
    'mode_automatic_desc' => 'Al inscribirse están automáticamente confirmados. (Desactiva "Requiere pago" y "Confirmación manual")',
    'mode_donation_title' => 'Por donación / Pago',
    'mode_donation_desc' => 'Requieren realizar un pago/donación y adjuntar su voucher para finalizar el registro.',
    'mode_manual_desc' => 'Un coordinador debe confirmar manualmente la participación.',
    'mode_mixed_title' => 'Mixto',
    'mode_mixed_desc' => 'Combina confirmación manual previa y el requisito de donación.',
    'amount_details' => '1. Detalles del monto',
    'payment_methods_enabled' => '2. Métodos de Pago Habilitados',
    'allow_scholarship_request' => 'Permitir Solicitud de Exención de Pago o Beca',
    'allow_scholarship_request_help' => 'Al habilitar esta opción, la app mostrará la opción "Solicitar exención o beca" permitiendo a los voluntarios justificar por qué no pueden realizar el pago mediante texto o archivo adjunto en la misma pantalla de pago.',
    'method_bank_transfer' => 'Transferencia Bancaria',
    'method_bank_transfer_help' => 'Requiere que suban un comprobante.',
    'method_link_pix' => 'Pago por Link / Pix',
    'method_link_pix_help' => 'Redirecciona a una plataforma externa.',
    'method_card' => 'Tarjeta Débito/Crédito',
    'method_card_help' => 'Integración directa (Si configurado).',
    'bank_transfer_data' => 'Datos para la Transferencia Bancaria',
    'bank_transfer_data_help' => 'Ingresa los datos de la cuenta bancaria. Este texto aparecerá bajo la opción "Transferencia".',
    'payment_link_url' => 'URL del Link de Pago',
    'payment_link_url_help' => 'Al usar este método, en la pantalla aparecerá el botón "Ir al link de pago" para que el voluntario pague en línea.',
    'message' => 'Mensaje',
    'others' => 'Otros',
    ...
    'save_generic_error' => 'No se pudieron guardar los cambios. Probá de nuevo.',
    ...
    'dates' => 'Fechas',
    'dates_activity' => 'Actividad',
    'dates_registrations' => 'Inscripciones',
    'dates_evaluations' => 'Evaluaciones',
    'edit_manually' => 'Editar manualmente',
    'restore_automatic' => 'Restaurar automático',
    'dates_auto_hint_registrations' => 'Fin = inicio de actividad · inicio = 10 días antes',
    'dates_auto_hint_evaluations' => 'Inicio = día siguiente al fin · fin = 30 días después',
    'status_opens_in_days' => 'Abre en {n} días',
    'status_opens_today' => 'Abre hoy',
    'status_opens_tomorrow' => 'Abre mañana',
    'status_closes_in_days' => 'Cierra en {n} días',
    'status_closes_today' => 'Cierra hoy',
    'status_closes_tomorrow' => 'Cierra mañana',
    'status_closed' => 'Cerrado',
    'status_starts_in_days' => 'Comienza en {n} días',
    'status_starts_today' => 'Comienza hoy',
    'status_starts_tomorrow' => 'Comienza mañana',
    'status_in_progress' => 'En curso',
    'status_in_progress_ends_in_days' => 'En curso · termina en {n} días',
    ...
    'granularity_quarterly' => 'Trimestral',
    ...
    'filtro_condicional_ayuda' => 'Si configurás un filtro, esta pregunta solo aparecerá si el usuario elige una respuesta específica en una pregunta anterior.',
    'filtro_especifico'     => 'Filtro específico',
    'filtro_sin_preguntas'  => 'Para usar un filtro necesitás al menos una pregunta desplegable anterior (con menor orden).',
    ...
    'confirm_convert_to_user'    => '¿Querés convertir este suscripto en usuario registrado?',
    'answer'                     => 'Respuesta',
    ...
    'create_column' => 'Crear columna',
    'delete_column_confirm' => '¿Eliminar esta columna? Los valores cargados dejarán de mostrarse.',
    'general_data' => 'Datos generales',
    'additional_questions' => 'Preguntas adicionales',
    'medical_record' => 'Ficha médica',
    'tracking' => 'Seguimiento',
    'column_type_casilla' => 'Casilla (sí/no)',
    'column_type_estado' => 'Estado (una opción)',
    'column_type_etiquetas' => 'Etiquetas (varias)',
    'column_type_texto' => 'Texto (nota libre)',
    'column_type_fecha' => 'Fecha',
    'column_type_persona' => 'Persona (coordinador)',
    'dni' => 'DNI / Pasaporte',
    'locality' => 'Localidad',
    'days' => 'Jornadas',
    'inscription_type' => 'Tipo de inscripción',
    'medical_coverage_number' => 'N° de cobertura',
    ...
    'view_voucher' => 'Ver comprobante',
    'voucher_column' => 'Comprobante de pago',
    'scholarship_column' => 'Beca / Exención',
    'requested' => 'Solicitada',
    'view_evidence' => 'Ver documentación',
    'scholarship_approve' => 'Aprobar beca',
    'scholarship_reject' => 'Rechazar beca',
    'scholarship_approved' => 'Aprobada',
    'scholarship_rejected' => 'Rechazada',
    'scholarship_approve_confirm' => '¿Aprobar la beca? Se marcará exención de pago y se confirmará la inscripción.',
    'scholarship_reject_confirm' => 'Confirmar rechazo',
    'scholarship_reject_reason_placeholder' => 'Motivo del rechazo (se enviará al voluntario)',
    'scholarship_action_error' => 'No se pudo completar la acción. Intentá de nuevo.',
    'approve_voucher' => 'Aprobar comprobante',
    'approve_voucher_confirm' => '¿Aprobar el comprobante? Se marcará el pago de la inscripción.',
    'scholarship_reject_title' => 'Rechazar solicitud de beca',
    'scholarship_reject_help' => 'Se notificará al voluntario por mail; podrá pagar o volver a solicitar la beca.',
    'scholarship_approved_ok' => 'Beca aprobada e inscripción confirmada.',
    'scholarship_rejected_ok' => 'Beca rechazada y usuario notificado.',
    'voucher_approved_ok' => 'Comprobante aprobado. Pago registrado.',
    'rejected' => 'Rechazado',
    'reject_voucher' => 'Rechazar comprobante',
    'reject_voucher_title' => 'Rechazar comprobante de pago',
    'reject_voucher_help' => 'Se notificará al voluntario por mail y podrá subir un nuevo comprobante.',
    'reason_optional' => 'Motivo (opcional)',
    'reject_voucher_placeholder' => 'Ej: La imagen no es legible, falta el monto...',
    'sending' => 'Enviando...',
    'reject_and_notify' => 'Rechazar y notificar',
    'voucher_rejected_ok' => 'Comprobante rechazado y usuario notificado.',
    ...
    'volunteer_level' => 'Nivel',
    'level_rookie' => 'Rookie',
    'level_champion' => 'Champion',
    'level_guardian' => 'Guardian',
    'general_evaluation' => 'Evaluación general',
    // Confianza de datos (calidad de datos progresiva)
    'data_confidence'       => 'Confianza de datos',
    'dq_level_ok'           => 'OK',
    'dq_level_revisar'      => 'Revisar',
    'dq_level_critico'      => 'Crítico',
    'dq_doc_missing'        => 'Falta el documento',
    'dq_doc_invalid'        => 'Documento con formato inválido',
    'dq_birth_missing'      => 'Falta la fecha de nacimiento',
    'dq_birth_invalid'      => 'Fecha de nacimiento inválida',
    'dq_birth_implausible'  => 'Edad poco plausible',
    'dq_name_missing'       => 'Falta el nombre',
    'dq_name_suspicious'    => 'Nombre sospechoso (posible apodo o relleno)',
    'dq_lastname_missing'   => 'Falta el apellido',
    'dq_lastname_suspicious' => 'Apellido sospechoso',
    'dq_verified_recently'  => 'Datos verificados recientemente',
    'id_document' => 'ID / Documento',
    'front' => 'Frente',
    'back' => 'Dorso',
    'reject_document' => 'Rechazar documento',
    'reject_document_title' => 'Rechazar documento de identidad',
    'reject_document_help' => 'Se notificará al voluntario por mail y podrá volver a subir el documento.',
    'reject_document_placeholder' => 'Ej: La imagen no es legible, no coincide el nombre...',
    'document_rejected_ok' => 'Documento rechazado y usuario notificado.',
];
