...
return [
	...
	*/
	...
	'application_description' => 'En TECHO, la voluntad nunca para. Hay equipos para todos los intereses y habilidades. Un espacio donde podés compartir ideas, trabajar en comunidad, liderar proyectos, organizar eventos y mucho más. Si querés hacer la diferencia (y cruzarte con gente increíble en el camino), este es tu lugar.',
	'application_descripcion_call' => '¿Te copás? Sumate a un área y sé parte del Equipo Permanente de TECHO. ¡Comenzó no para! 🚀',
	...
	'link_rrss_help' => 'Ya existe una cuenta de TECHO con este correo. Vinculá tu red social para ingresar con ella la próxima vez.',
	'confirm' => 'Confirmar',	
	...
	'telephone'  =>  'TELEFONO',
	'phone_placeholder'  =>  'Ingresá tu teléfono',
	...
	'whats_a_rol' => 'Comienza a escribir para ver las opciones de roles disponibles para esta actividad.',
	...
	'suggested_donation' => 'Valor de Inscripción: ',
	'suggested_donation_between' => 'Valor de Inscripción: Entre ',
	'and' => ' y ',
	'also_you_can' => 'o también podés ',
	'ask_for_grant' => 'SOLICITAR UNA BECA',
	'go_back' => 'VOLVER',
	// Microprompt de verificación de datos (calidad de datos)
	'vd_titulo' => 'Revisá tus datos',
	'vd_texto' => 'Necesitamos que estos datos estén bien para tu seguro. Confirmá que son correctos o corregilos.',
	...
	'payment_select_method'          => 'Por favor seleccioná el método mediante el cual deseás realizar tu aporte. Te enviaremos confirmación de tu participación por correo electrónico una vez que se haya procesado tu pago.',
	'payment_method_card'            => 'Tarjeta Crédito/Débito',
	'payment_no_method_available'    => 'Esta actividad no tiene ningún método de pago habilitado por el momento. Por favor contactá al coordinador.',
	...
	'payment_link_instructions'      => 'Hacé click en el botón para ir al link de pago externo.',
	'go_to_payment_link'             => 'Ir al Link de Pago',
	'payment_link_description'       => 'El pago deberá efectuarse a través del enlace externo a continuación. Después de realizar el pago en la plataforma, por favor regresá a esta página y enviá la imagen de tu comprobante al lado para que verifiquemos y validemos tu donación.',
	...
	'scholarship_panel_description'  => 'Si no podés realizar una donación, podés solicitar una beca o exención. Contanos brevemente tu situación y, de manera opcional, adjuntá documentación de respaldo.',
	'scholarship_reason_placeholder' => 'Explicá brevemente por qué solicitás la beca o exención...',
	'scholarship_reason_required'    => 'Por favor explicá el motivo de tu solicitud.',
	...
	'scholarship_success_subtitle'   => 'Revisaremos tu solicitud y nos comunicaremos con vos para confirmar tu participación.',
	'valor_label'                    => 'Valor:',
	// confirmacionPago.vue
	'voucher_click_to_browse'        => 'Haz clic para buscar',
	'voucher_drag_drop'              => 'o arrastrá y soltá aquí tu archivo',
    ...
    'terms_section_title' => 'Para finalizar, aceptá los términos',
    'read_more' => 'Ver más',
    'read_less' => 'Ver menos',
	...
	'feedback_to_your_peers' => '3. Evalúa a participantes',
