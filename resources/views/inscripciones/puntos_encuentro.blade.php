        ...
        <div class="col-md-8">
            ...
            <form action="/inscripciones/actividad/{{$actividad->idActividad}}/confirmar" method="POST">
                @foreach($actividad->puntosEncuentro as $puntoEncuentro)
                    <div class="row">
                        <div class="col-md-1">
                            <input type="radio" name="punto_encuentro"
                                   value="{{$puntoEncuentro->idPuntoEncuentro}}"{{$loop->first ? 'checked = "checked"': ''}}>
                        </div>
                        <div class="col-md-11">
                ...
                <div class="row  align-middle">
                    ...
                    <div class="col-md-3 text-primary"><i class="fas fa-long-arrow-alt-left "></i><a
                                href="/actividades/{{$actividad->idActividad}}"> Volver</a></div>
