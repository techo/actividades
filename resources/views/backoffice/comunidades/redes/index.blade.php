...
@section('page_title', $comunidad->nombre . ' - ' . __('backend.redes'))
...
@section('content')
    ...
    <div class="nav-tabs-custom">
        @include('backoffice.comunidades.tabs' , [ 'tab' => 'redes' , 'idComunidad' => $idComunidad])
    
        <div class="tab-content">
            <div class="tab-pane active" id="redes-comunidad">
                <div class="box">
                    <div class="box-body  with-border">
                    <redes-datatable
                        api-url="/admin/ajax/comunidades/{{ $idComunidad }}/red"
                        fields="{{ $fields }}"
