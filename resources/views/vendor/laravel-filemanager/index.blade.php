...
<body>
  <div class="container-fluid" id="wrapper">
    @if(auth()->user()->hasPermissionTo('administrar_imagenes'))
    ...
    <div class="row">
      ...
      @else
        <div style="position: absolute; top: 30%; left: 5%;">
          <h2>No tiene permisos para administrar imágenes. Por favor, contacte al administrador del sistema.</h2>
        </div>
      @endif
  </div>
  ...
  <script>{!! \File::get(resource_path('assets/vendor/laravel-filemanager/script.js')) !!}</script>
