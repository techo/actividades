{{-- Logo de WhatsApp como SVG inline (self-hosted). No depende de FontAwesome
     ni de ningún CDN externo con cuota, así el logo siempre se renderiza.
     Hereda color con currentColor y tamaño con la font-size (1em). --}}
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
     width="1em" height="1em" fill="currentColor" aria-hidden="true"
     focusable="false" style="vertical-align:-0.125em;">
