    ...
    @if($inscripcion->actividad->show_dates || $inscripcion->actividad->show_location)
        <p style="margin:0; font-size:15px; line-height:1.5; color:#2b2f36;">
            ...
            @if($inscripcion->actividad->show_location)
                ...
                <strong>@if($inscripcion->actividad->idLocalidad){{optional($inscripcion->actividad->localidad)->localidad}}, @endif{{optional($inscripcion->actividad->provincia)->provincia}}, {{optional($inscripcion->actividad->pais)->nombre}}</strong>
            @endif
        </p>
    @endif
