...
@section('content')
    ...
    <p>
        @lang('email.documento_rechazado_intro') <strong>{{ $inscripcion->actividad->nombreActividad }}</strong>.
    </p>
    <p>
        <strong>
            <span style="color:rgb(200,50,50)">@lang('email.documento_rechazado_estado')</span>
        </strong>
    </p>

    @if($motivo)
    <p>
        <strong>@lang('email.documento_rechazado_motivo_label'):</strong><br>
        {{ $motivo }}
    </p>
    @endif
