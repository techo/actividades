<template>
    <div :style='{width:width}' class="datetime-picker" v-on:click='calendarClicked($event)'>
        <div>
            <input type='text' id='tj-datetime-input' :value="date" :name='name' v-on:click='toggleCal'
                   autocomplete='off'/>
                ...
                <div :class='{noDisplay: hideDate}'>
                    <div class='year-month-wrapper'>
                        ...
                        <div class='month-setter'>
                            ...
                            <button type='button' class='nav-r' v-on:click='rightMonth' v-on:mousedown=''>&#x3E;
                            </button>
                        </div>
                    </div>
                    <div class='headers'>
                    ...
                    <div>
                        <span class="port" v-for="(port, index) in ports" :class='{activePort: index === activePort}'
                              v-on:click='setDay(index, port)'>{{port}}</span>
                    </div>
                </div>
                <div class='time-picker' :class='{noDisplay: hideTime}'>
                    <div class='hour-selector'>
                        <div v-on:click='showHourSelector' id='j-hour'>{{hour}}</div>
                        <div class='scroll-hider' ref='hourScrollerWrapper'
                             :class='{showSelector: hourSelectorVisible}'>
                            <ul ref='hourScroller'>
                                <li v-for="(h, index) in hours" :class='{active: index == hourIndex}'
                                    v-on:click='setHour(index, true)'>{{h}}
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class='minute-selector'>
                        ...
                        <div class='scroll-hider' ref='minuteScrollerWrapper'
                             :class='{showSelector: minuteSelectorVisible}'>
                            <ul ref='minuteScroller'>
                                <li v-for="(m, index) in minutes" :class='{active: index == minuteIndex}'
                                    v-on:click='setMinute(index, true)'>{{m}}
                                </li>
                            </ul>
                        </div>
                    </div>
