<template>
    <div>
        <!-- Modal -->
        <div class="modal fade" id="campana-preguntas-modal" tabindex="-1" role="dialog">
...
export default {
    ...
    methods: {
        ...
        cargarPreguntas() {
            this.cargando = true;
            axios.get('/admin/ajax/campanas/' + this.campanaId + '/preguntas')
        ...
        abrirModalCrear() {
            ...
            $('#campana-preguntas-modal').modal('show');
        },
        abrirModalEditar(pregunta) {
            ...
            this.opcionesTags = Array.isArray(pregunta.opciones)
                ? pregunta.opciones.map(function(o) { return { text: o }; })
                : [];
            this.tagOpcion = '';
            this.errors = {};
            this.errorGeneral = null;
        ...
        cancelar() {
            $('#campana-preguntas-modal').modal('hide');
            this.form = this.formVacio();
            this.opcionesTags = [];
            this.tagOpcion = '';
            this.errors = {};
        ...
        payload() {
            return {
                ...
                opciones:    this.form.tipo === 'desplegable'
                                ? this.opcionesTags.map(function(t) { return t.text; })
                                : [],
        ...
        crear() {
            this.guardando = true;
            this.errorGeneral = null;
            axios.post('/admin/ajax/campanas/' + this.campanaId + '/preguntas', this.payload())
                .then(() => {
                    this.cargarPreguntas();
                    this.cancelar();
                })
        ...
        actualizar() {
            this.guardando = true;
            this.errorGeneral = null;
            axios.put('/admin/ajax/campanas/' + this.campanaId + '/preguntas/' + this.form.id, this.payload())
                .then(() => {
                    this.cargarPreguntas();
                    this.cancelar();
                })
        ...
        eliminar() {
            axios.delete('/admin/ajax/campanas/' + this.campanaId + '/preguntas/' + this.form.id)
                .then(() => {
                    this.cargarPreguntas();
                    this.cancelar();
                })
