<template>
  <div>
    ...
    <tipos-actividad-filter-bar v-bind:placeholder-text="dataPlaceholderText"></tipos-actividad-filter-bar>
    <vuetable
      class="vuetable"
      ref="vuetable"
...
<script>
  ...
  import FilterBar from './TiposActividadFilterBar'
  ...
  Vue.component('tipos-actividad-filter-bar', FilterBar);
