<template>
  <div>
    <referente-modal :id-comunidad="idComunidad"  @actualizar="refrescarTabla"></referente-modal>
    <div class="row">
      <div class="col-md-12">
...
export default {
  components: {
    ...
    props: ['apiUrl', 'fields', 'sortOrder', 'placeholder-text', 'detail-url', 'idComunidad'],
    data () {
    return {
  ...
  methods: {
    ...
    desplegarModal() {
      Event.$emit('referente:crear');
    },
    onCellClicked (data, field, event) { 
      console.log(data);
      Event.$emit('referente:editar', data);
    },
      bold: function(value) {
          return '<b>' + value + '</b>';
      },
