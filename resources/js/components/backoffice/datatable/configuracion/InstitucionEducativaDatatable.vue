<template>
  <div>
    ...
    <!-- <div style="text-align: right">
				<button class="btn btn-default" @click="exportarprovincias()" >Descargar<i class="fa fa-download"></i></button>
			</div> -->
  ...
  methods: {
    ...
    onCellClicked (data, field, event) {
        if (this.detailUrl !== undefined) {
            window.location.href = this.detailUrl + data.idInstitucionEducativa;
        }
    ...
    exportarInstitucionEducativa: function() {
			this.loading = true;
			axios({
				url: '/admin/institucionEducativa/exportar', 
				params: null,
				responseType: 'blob',
				headers: { 
			...
			.then((response) => {
				...
				link.href = url;
				link.setAttribute('download', 'InstitucionEducativa.xlsx');
