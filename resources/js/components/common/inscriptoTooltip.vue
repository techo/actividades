<template>
    <div class="tooltip-container row mx-2">
      <div 
        class="col-md-3 p-1" 
        v-for="inscripto in inscriptos" 
        :key="inscripto.idPersona"
      >
        <!-- Imagen principal -->
        ...
        <transition name="fade">
          <div 
            v-if="tooltipAbierto === inscripto.idPersona" 
          ...
          >
            ...
            <div class="tooltip-info">
              ...
              <!-- <a 
                v-if="isValidWhatsAppNumber(persona.telefonoMovil)" 
                :href="'https://wa.me/' + persona.telefonoMovil" 
                target="_blank" 
