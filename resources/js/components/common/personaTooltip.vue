    ...
    <div class="tooltip-container row mx-2">
      ...
      >
        ...
        <transition name="fade">
          <div 
            v-if="tooltipAbierto === persona.persona.idPersona" 
          ...
          >
            ...
            <div class="tooltip-info">
              ...
              <a 
                v-if="persona.persona.instagram"
                :href="'https://instagram.com/' + persona.persona.instagram" 
                target="_blank" 
              ...
              <a 
                v-if="isValidWhatsAppNumber(persona.persona.telefonoMovil)" 
                :href="'https://wa.me/' + persona.persona.telefonoMovil" 
                target="_blank" 
